...
const char servCertLoc[] = "./server-cert/server.service.cert.pem";
const char servKeyLoc[] = "./server-cert/server.service.key.pem";
const char clientCertLoc[] = "./client-cert/client.client.cert.pem";
const char clientKeyLoc[] = "./client-cert/client.client.key.pem";
