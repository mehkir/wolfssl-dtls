...
int main(int argc, char** argv)
{
    ...
    if (wolfSSL_CTX_load_verify_locations(ctx,clientCertLoc,0) !=
            SSL_SUCCESS) {
    ...
    wolfSSL_CTX_set_verify(ctx, (WOLFSSL_VERIFY_PEER | WOLFSSL_VERIFY_FAIL_IF_NO_PEER_CERT), my_verify_callback);
